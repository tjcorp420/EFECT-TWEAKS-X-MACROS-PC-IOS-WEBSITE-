(() => {
  ...
  const catalog = {
    ...
    capture: { name: "EMX Clips", label: "Recommended for local replay", copy: "A local-first instant replay workflow for supported Windows and NVIDIA NVENC setups. Confirm capture compatibility before access.", href: "./products.html#product-clips", image: "assets/emx-clips/emx-clips-cover.png", price: "$1.00" },
