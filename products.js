window.EMX_PRODUCTS = [
  ...
  },
  {
    id: "emx_tweaks_pro",
    key: "tkYJN",
    productUrl: "https://payhip.com/b/tkYJN",
    title: "EMX Tweaks Pro",
    eyebrow: "Complete Premium Windows Utility",
    price: 35.00,
    oldPrice: 0,
    image: "./assets/emx-tweaks-pro-product.png",
    gallery: ["./assets/emx-tweaks-pro-product.png"],
    previewType: "image",
    ...
    features: [
      ...
      "Windows repair, update, DNS, AppX, and optional-feature management",
      "Standard, Minimal, Advanced, and AppX presets",
    ...
    version: "1.0.0",
    platform: "Windows 10 + 11",
    purpose: "Complete Windows configuration, repair, application, and optimization utility",
    licenseType: "Lifetime one-PC EMX Tweaks Pro license",
    controllerSupport: "Not required",
    requirements: ["64-bit Windows 10 or Windows 11", "Administrator access", "Internet access for activation and periodic verification"],
    recovery: ["Use the utility's Undo Selected Tweaks controls", "Create a Windows restore point before grouped system changes", "Review operation logs when a change fails"],
    limitations: ["Results depend on the Windows installation and hardware", "No specific FPS, latency, or performance improvement is guaranteed", "The executable is not Authenticode-signed"],
